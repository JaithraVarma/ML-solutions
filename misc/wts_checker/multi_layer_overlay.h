...
#define WTS_DDR_MEM_SIZE (25892864)
...
std::vector<location_constraint> wts_loc_46 = {address(1, 1, 229376), address(2, 1, 376832)};
std::vector<location_constraint> wts_loc_47 = {address(1, 1, 450560), address(2, 1, 487424)};
...
std::vector<location_constraint> wts_loc_50 = {address(1, 1, 450560), address(2, 1, 487424)};
...
std::vector<location_constraint> wts_loc_53 = {address(1, 1, 450560), address(2, 1, 487424)};
...
uint32_t in1_ping = 0x0,
uint32_t in1_pong = 0x0,
uint32_t in2_ping = 0x0,
uint32_t in2_pong = 0x0)
{
...
for (int col = 0; col < 4; col++){
  ...
  for (int row = 0; row < 4 ; row++){
    ...
    case 0:{
      ...
      location<buffer>(compute_node[col][row].in[0]) = {address(col+0,row,in0_ping), address(col+0,row,in0_pong)};
      location<buffer>(compute_node[col][row].in[1]) = {address(col+0,row,in1_ping), address(col+0,row,in1_pong)};
    ...
    case 1:{
      ...
      location<buffer>(compute_node[col][row].in[0]) = {address(col+0,row,in0_ping), address(col+0,row,in0_pong)};
      location<buffer>(compute_node[col][row].in[1]) = {address(col+0,row,in1_ping), address(col+0,row,in1_pong)};
      location<buffer>(compute_node[col][row].in[2]) = {address(col+0,row,in2_ping), address(col+0,row,in2_pong)};
      location<dma>(compute_node[col][row].in[0]) = dma_channel(aie_tile,col+0,row,0);
      location<dma>(compute_node[col][row].in[1]) = dma_channel(aie_tile,col+0,row,1);
    ...
    location<stack>(compute_node[col][row]) = {address(col+0,row,0xb5a0)};
...
single_layer_overlay(0,8,ofm_pattern_1,wts_pattern_1,wts_ddr_read_pattern_1,wts_ddr_write_pattern_1,wts_ddr_dim_1,ofmsv_size_1,wtssv_size_1,ofm_loc_1,wts_loc_1,kernel_iter_1,ofm_repetition_1,1,1,0x8000,0xca60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_2,wts_pattern_2,wts_ddr_read_pattern_2,wts_ddr_write_pattern_2,wts_ddr_dim_2,ofmsv_size_2,wtssv_size_2,ofm_loc_2,wts_loc_2,kernel_iter_2,ofm_repetition_2,1,1,0x8000,0xca60,0x8e00,0xd860),
single_layer_overlay(0,4,ofm_pattern_3,wts_pattern_3,wts_ddr_read_pattern_3,wts_ddr_write_pattern_3,wts_ddr_dim_3,ofmsv_size_3,wtssv_size_3,ofm_loc_3,wts_loc_3,kernel_iter_3,ofm_repetition_3,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(0,4,ofm_pattern_4,wts_pattern_4,wts_ddr_read_pattern_4,wts_ddr_write_pattern_4,wts_ddr_dim_4,ofmsv_size_4,wtssv_size_4,ofm_loc_4,wts_loc_4,kernel_iter_4,ofm_repetition_4,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(1,8,ofm_pattern_5,wts_pattern_5,wts_ddr_read_pattern_5,wts_ddr_write_pattern_5,wts_ddr_dim_5,ofmsv_size_5,wtssv_size_5,ofm_loc_5,wts_loc_5,kernel_iter_5,ofm_repetition_5,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_6,wts_pattern_6,wts_ddr_read_pattern_6,wts_ddr_write_pattern_6,wts_ddr_dim_6,ofmsv_size_6,wtssv_size_6,ofm_loc_6,wts_loc_6,kernel_iter_6,ofm_repetition_6,1,1,0x8000,0xca60,0x8e00,0xd860),
single_layer_overlay(0,4,ofm_pattern_7,wts_pattern_7,wts_ddr_read_pattern_7,wts_ddr_write_pattern_7,wts_ddr_dim_7,ofmsv_size_7,wtssv_size_7,ofm_loc_7,wts_loc_7,kernel_iter_7,ofm_repetition_7,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(1,8,ofm_pattern_8,wts_pattern_8,wts_ddr_read_pattern_8,wts_ddr_write_pattern_8,wts_ddr_dim_8,ofmsv_size_8,wtssv_size_8,ofm_loc_8,wts_loc_8,kernel_iter_8,ofm_repetition_8,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_9,wts_pattern_9,wts_ddr_read_pattern_9,wts_ddr_write_pattern_9,wts_ddr_dim_9,ofmsv_size_9,wtssv_size_9,ofm_loc_9,wts_loc_9,kernel_iter_9,ofm_repetition_9,1,1,0x8000,0xca60,0x8e00,0xd860),
single_layer_overlay(0,4,ofm_pattern_10,wts_pattern_10,wts_ddr_read_pattern_10,wts_ddr_write_pattern_10,wts_ddr_dim_10,ofmsv_size_10,wtssv_size_10,ofm_loc_10,wts_loc_10,kernel_iter_10,ofm_repetition_10,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(1,8,ofm_pattern_11,wts_pattern_11,wts_ddr_read_pattern_11,wts_ddr_write_pattern_11,wts_ddr_dim_11,ofmsv_size_11,wtssv_size_11,ofm_loc_11,wts_loc_11,kernel_iter_11,ofm_repetition_11,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_12,wts_pattern_12,wts_ddr_read_pattern_12,wts_ddr_write_pattern_12,wts_ddr_dim_12,ofmsv_size_12,wtssv_size_12,ofm_loc_12,wts_loc_12,kernel_iter_12,ofm_repetition_12,1,1,0x8000,0xca60,0x9800,0xe260),
single_layer_overlay(0,4,ofm_pattern_13,wts_pattern_13,wts_ddr_read_pattern_13,wts_ddr_write_pattern_13,wts_ddr_dim_13,ofmsv_size_13,wtssv_size_13,ofm_loc_13,wts_loc_13,kernel_iter_13,ofm_repetition_13,1,1,0x8000,0xca60,0x9100,0xdb60),
single_layer_overlay(0,4,ofm_pattern_14,wts_pattern_14,wts_ddr_read_pattern_14,wts_ddr_write_pattern_14,wts_ddr_dim_14,ofmsv_size_14,wtssv_size_14,ofm_loc_14,wts_loc_14,kernel_iter_14,ofm_repetition_14,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(1,8,ofm_pattern_15,wts_pattern_15,wts_ddr_read_pattern_15,wts_ddr_write_pattern_15,wts_ddr_dim_15,ofmsv_size_15,wtssv_size_15,ofm_loc_15,wts_loc_15,kernel_iter_15,ofm_repetition_15,1,1,0x8000,0xca60,0x9c00,0xe660,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_16,wts_pattern_16,wts_ddr_read_pattern_16,wts_ddr_write_pattern_16,wts_ddr_dim_16,ofmsv_size_16,wtssv_size_16,ofm_loc_16,wts_loc_16,kernel_iter_16,ofm_repetition_16,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_17,wts_pattern_17,wts_ddr_read_pattern_17,wts_ddr_write_pattern_17,wts_ddr_dim_17,ofmsv_size_17,wtssv_size_17,ofm_loc_17,wts_loc_17,kernel_iter_17,ofm_repetition_17,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(1,8,ofm_pattern_18,wts_pattern_18,wts_ddr_read_pattern_18,wts_ddr_write_pattern_18,wts_ddr_dim_18,ofmsv_size_18,wtssv_size_18,ofm_loc_18,wts_loc_18,kernel_iter_18,ofm_repetition_18,1,1,0x8000,0xca60,0x9c00,0xe660,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_19,wts_pattern_19,wts_ddr_read_pattern_19,wts_ddr_write_pattern_19,wts_ddr_dim_19,ofmsv_size_19,wtssv_size_19,ofm_loc_19,wts_loc_19,kernel_iter_19,ofm_repetition_19,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_20,wts_pattern_20,wts_ddr_read_pattern_20,wts_ddr_write_pattern_20,wts_ddr_dim_20,ofmsv_size_20,wtssv_size_20,ofm_loc_20,wts_loc_20,kernel_iter_20,ofm_repetition_20,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(1,8,ofm_pattern_21,wts_pattern_21,wts_ddr_read_pattern_21,wts_ddr_write_pattern_21,wts_ddr_dim_21,ofmsv_size_21,wtssv_size_21,ofm_loc_21,wts_loc_21,kernel_iter_21,ofm_repetition_21,1,1,0x8000,0xca60,0x9c00,0xe660,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_22,wts_pattern_22,wts_ddr_read_pattern_22,wts_ddr_write_pattern_22,wts_ddr_dim_22,ofmsv_size_22,wtssv_size_22,ofm_loc_22,wts_loc_22,kernel_iter_22,ofm_repetition_22,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_23,wts_pattern_23,wts_ddr_read_pattern_23,wts_ddr_write_pattern_23,wts_ddr_dim_23,ofmsv_size_23,wtssv_size_23,ofm_loc_23,wts_loc_23,kernel_iter_23,ofm_repetition_23,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(1,8,ofm_pattern_24,wts_pattern_24,wts_ddr_read_pattern_24,wts_ddr_write_pattern_24,wts_ddr_dim_24,ofmsv_size_24,wtssv_size_24,ofm_loc_24,wts_loc_24,kernel_iter_24,ofm_repetition_24,1,1,0x8000,0xca60,0x9c00,0xe660,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_25,wts_pattern_25,wts_ddr_read_pattern_25,wts_ddr_write_pattern_25,wts_ddr_dim_25,ofmsv_size_25,wtssv_size_25,ofm_loc_25,wts_loc_25,kernel_iter_25,ofm_repetition_25,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_26,wts_pattern_26,wts_ddr_read_pattern_26,wts_ddr_write_pattern_26,wts_ddr_dim_26,ofmsv_size_26,wtssv_size_26,ofm_loc_26,wts_loc_26,kernel_iter_26,ofm_repetition_26,1,1,0x8000,0xca60,0x9680,0xe0e0),
single_layer_overlay(0,4,ofm_pattern_27,wts_pattern_27,wts_ddr_read_pattern_27,wts_ddr_write_pattern_27,wts_ddr_dim_27,ofmsv_size_27,wtssv_size_27,ofm_loc_27,wts_loc_27,kernel_iter_27,ofm_repetition_27,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(1,8,ofm_pattern_28,wts_pattern_28,wts_ddr_read_pattern_28,wts_ddr_write_pattern_28,wts_ddr_dim_28,ofmsv_size_28,wtssv_size_28,ofm_loc_28,wts_loc_28,kernel_iter_28,ofm_repetition_28,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_29,wts_pattern_29,wts_ddr_read_pattern_29,wts_ddr_write_pattern_29,wts_ddr_dim_29,ofmsv_size_29,wtssv_size_29,ofm_loc_29,wts_loc_29,kernel_iter_29,ofm_repetition_29,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_30,wts_pattern_30,wts_ddr_read_pattern_30,wts_ddr_write_pattern_30,wts_ddr_dim_30,ofmsv_size_30,wtssv_size_30,ofm_loc_30,wts_loc_30,kernel_iter_30,ofm_repetition_30,1,1,0x8000,0xca60,0x8f00,0xd960),
single_layer_overlay(1,8,ofm_pattern_31,wts_pattern_31,wts_ddr_read_pattern_31,wts_ddr_write_pattern_31,wts_ddr_dim_31,ofmsv_size_31,wtssv_size_31,ofm_loc_31,wts_loc_31,kernel_iter_31,ofm_repetition_31,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_32,wts_pattern_32,wts_ddr_read_pattern_32,wts_ddr_write_pattern_32,wts_ddr_dim_32,ofmsv_size_32,wtssv_size_32,ofm_loc_32,wts_loc_32,kernel_iter_32,ofm_repetition_32,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_33,wts_pattern_33,wts_ddr_read_pattern_33,wts_ddr_write_pattern_33,wts_ddr_dim_33,ofmsv_size_33,wtssv_size_33,ofm_loc_33,wts_loc_33,kernel_iter_33,ofm_repetition_33,1,1,0x8000,0xca60,0x8f00,0xd960),
single_layer_overlay(1,8,ofm_pattern_34,wts_pattern_34,wts_ddr_read_pattern_34,wts_ddr_write_pattern_34,wts_ddr_dim_34,ofmsv_size_34,wtssv_size_34,ofm_loc_34,wts_loc_34,kernel_iter_34,ofm_repetition_34,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_35,wts_pattern_35,wts_ddr_read_pattern_35,wts_ddr_write_pattern_35,wts_ddr_dim_35,ofmsv_size_35,wtssv_size_35,ofm_loc_35,wts_loc_35,kernel_iter_35,ofm_repetition_35,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_36,wts_pattern_36,wts_ddr_read_pattern_36,wts_ddr_write_pattern_36,wts_ddr_dim_36,ofmsv_size_36,wtssv_size_36,ofm_loc_36,wts_loc_36,kernel_iter_36,ofm_repetition_36,1,1,0x8000,0xca60,0x8f00,0xd960),
single_layer_overlay(1,8,ofm_pattern_37,wts_pattern_37,wts_ddr_read_pattern_37,wts_ddr_write_pattern_37,wts_ddr_dim_37,ofmsv_size_37,wtssv_size_37,ofm_loc_37,wts_loc_37,kernel_iter_37,ofm_repetition_37,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_38,wts_pattern_38,wts_ddr_read_pattern_38,wts_ddr_write_pattern_38,wts_ddr_dim_38,ofmsv_size_38,wtssv_size_38,ofm_loc_38,wts_loc_38,kernel_iter_38,ofm_repetition_38,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_39,wts_pattern_39,wts_ddr_read_pattern_39,wts_ddr_write_pattern_39,wts_ddr_dim_39,ofmsv_size_39,wtssv_size_39,ofm_loc_39,wts_loc_39,kernel_iter_39,ofm_repetition_39,1,1,0x8000,0xca60,0x8f00,0xd960),
single_layer_overlay(1,8,ofm_pattern_40,wts_pattern_40,wts_ddr_read_pattern_40,wts_ddr_write_pattern_40,wts_ddr_dim_40,ofmsv_size_40,wtssv_size_40,ofm_loc_40,wts_loc_40,kernel_iter_40,ofm_repetition_40,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_41,wts_pattern_41,wts_ddr_read_pattern_41,wts_ddr_write_pattern_41,wts_ddr_dim_41,ofmsv_size_41,wtssv_size_41,ofm_loc_41,wts_loc_41,kernel_iter_41,ofm_repetition_41,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_42,wts_pattern_42,wts_ddr_read_pattern_42,wts_ddr_write_pattern_42,wts_ddr_dim_42,ofmsv_size_42,wtssv_size_42,ofm_loc_42,wts_loc_42,kernel_iter_42,ofm_repetition_42,1,1,0x8000,0xca60,0x8f00,0xd960),
single_layer_overlay(1,8,ofm_pattern_43,wts_pattern_43,wts_ddr_read_pattern_43,wts_ddr_write_pattern_43,wts_ddr_dim_43,ofmsv_size_43,wtssv_size_43,ofm_loc_43,wts_loc_43,kernel_iter_43,ofm_repetition_43,1,1,0x8000,0xca60,0x8400,0xce60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_44,wts_pattern_44,wts_ddr_read_pattern_44,wts_ddr_write_pattern_44,wts_ddr_dim_44,ofmsv_size_44,wtssv_size_44,ofm_loc_44,wts_loc_44,kernel_iter_44,ofm_repetition_44,1,1,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_45,wts_pattern_45,wts_ddr_read_pattern_45,wts_ddr_write_pattern_45,wts_ddr_dim_45,ofmsv_size_45,wtssv_size_45,ofm_loc_45,wts_loc_45,kernel_iter_45,ofm_repetition_45,4,2,0x8000,0xca60,0x8d80,0xd7e0),
single_layer_overlay(0,4,ofm_pattern_46,wts_pattern_46,wts_ddr_read_pattern_46,wts_ddr_write_pattern_46,wts_ddr_dim_46,ofmsv_size_46,wtssv_size_46,ofm_loc_46,wts_loc_46,kernel_iter_46,ofm_repetition_46,4,2,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(1,8,ofm_pattern_47,wts_pattern_47,wts_ddr_read_pattern_47,wts_ddr_write_pattern_47,wts_ddr_dim_47,ofmsv_size_47,wtssv_size_47,ofm_loc_47,wts_loc_47,kernel_iter_47,ofm_repetition_47,2,2,0x8000,0xca60,0x9000,0xda60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_48,wts_pattern_48,wts_ddr_read_pattern_48,wts_ddr_write_pattern_48,wts_ddr_dim_48,ofmsv_size_48,wtssv_size_48,ofm_loc_48,wts_loc_48,kernel_iter_48,ofm_repetition_48,2,2,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_49,wts_pattern_49,wts_ddr_read_pattern_49,wts_ddr_write_pattern_49,wts_ddr_dim_49,ofmsv_size_49,wtssv_size_49,ofm_loc_49,wts_loc_49,kernel_iter_49,ofm_repetition_49,4,2,0x8000,0xca60,0x8a00,0xd460),
single_layer_overlay(1,8,ofm_pattern_50,wts_pattern_50,wts_ddr_read_pattern_50,wts_ddr_write_pattern_50,wts_ddr_dim_50,ofmsv_size_50,wtssv_size_50,ofm_loc_50,wts_loc_50,kernel_iter_50,ofm_repetition_50,2,2,0x8000,0xca60,0x9000,0xda60,0x2000,0x6000),
single_layer_overlay(0,4,ofm_pattern_51,wts_pattern_51,wts_ddr_read_pattern_51,wts_ddr_write_pattern_51,wts_ddr_dim_51,ofmsv_size_51,wtssv_size_51,ofm_loc_51,wts_loc_51,kernel_iter_51,ofm_repetition_51,2,2,0x8000,0xca60,0x9000,0xda60),
single_layer_overlay(0,4,ofm_pattern_52,wts_pattern_52,wts_ddr_read_pattern_52,wts_ddr_write_pattern_52,wts_ddr_dim_52,ofmsv_size_52,wtssv_size_52,ofm_loc_52,wts_loc_52,kernel_iter_52,ofm_repetition_52,4,2,0x8000,0xca60,0x8a00,0xd460),
single_layer_overlay(1,1,ofm_pattern_53,wts_pattern_53,wts_ddr_read_pattern_53,wts_ddr_write_pattern_53,wts_ddr_dim_53,ofmsv_size_53,wtssv_size_53,ofm_loc_53,wts_loc_53,kernel_iter_53,ofm_repetition_53,2,2,0x8000,0xca60,0x9000,0xda60,0x2000,0x6000)
};
...
location<dma>(flexml_layers[NUM_LAYERS-1].ofm.out[0]) = dma_channel(memory_tile, 2, 0, 0);
}
};
