...
class GoogLeNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv_layer1 = nn.Conv2d(in_channels=480,  # Assuming the input has 288 channels
                                           out_channels=480,
                                           kernel_size=3,
                                           stride=1,
                                           padding=1)
        self.conv_layer2 = nn.Conv2d(in_channels=832,  # Assuming the input has 288 channels
                                           out_channels=832,
                                           kernel_size=3,
                                           stride=1,
                                           padding=1)
    ...
    def _forward(self, x: Tensor) -> Tuple[Tensor, Optional[Tensor], Optional[Tensor]]:
        ...
        mm = self.inception4e(x)
        print(x[0][0][0][:])

        # N x 832 x 14 x 14
        x=self.conv_layer2(mm)
        print((mm==x).all())
        print(x[0][0][0][:])
...
class Inception(nn.Module):
    def __init__(
        ...
        self.conv_inception=nn.Conv2d(in_channels=in_channels,  # Assuming the input has 288 channels
    ...
    def _forward(self, x: Tensor) -> List[Tensor]:
        ...
        branch4_conv=self.conv_inception(x)
        branch4 = self.branch4(branch4_conv)
